...
app.factory('ServiceList', function() { 
	...
	var services = [
		{
			name: 'Mandrill',
			url: 'http://mandrill.com/pricing/',
			image: 'mandrill.png',
			notes: 'By MailChimp',
            free: 12000,
			prices: [
				{ price_per_email: 0.0002, emails_a_month: 1000000 },
        ...
        {
			name: 'sendwithus',
			url: 'https://www.sendwithus.com/pricing',
			image: 'sendwithus.png',
			notes: 'Includes A/B testing, drip campaigns, email templates and unlimited email sends, limits are on recipients.',
            free: 1000,
			prices: [
